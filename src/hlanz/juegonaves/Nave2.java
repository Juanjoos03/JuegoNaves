...
public class Nave2 extends Nave{
    ...
    /*
    se creará y añadirá a la escena del juego un objeto Disparo en las coordenadas (x,y) de la nave con una
    velocidad de 0 píxeles en el eje x y -10 píxeles en el eje Y (con esto conseguimos que el disparo se mueva hacia arriba). El
