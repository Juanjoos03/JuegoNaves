...
public abstract class Nave extends SpriteGameObject{
    ...
    public void ejecutarFrame() {
        ...
        if(this.consola.getTeclado().teclaPulsada(teclaDerecha)&&this.getX()+this.getAnchura()<this.juego.getAnchuraPantalla()){
            this.moverX(+velocidad);
        }
    ...
    public void disparar(){
        ...
        if(Duration.between( ultimoDisparoRealizado,now).getNano()>200000000){
