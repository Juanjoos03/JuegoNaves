    ...
    public void ejecutarFrame() {
        ...
        if(this.escena instanceof JuegoNaves j){
            ...
            for(int i=0;i<lista.size();i++){
                /*if(this.getX()>=j.getEnemigos().get(i).getY()&&this.getX()>=j.getEnemigos().get(i).getX()&&this.getX()>=j.getEnemigos().get(i).getAnchura()){
                    j.getEnemigos().get(i).finalizar();
                    this.finalizar();
                    //Incrementar puntos
                    
                }
                if(this.getX()>=j.getEnemigos().get(i).getY()-j.getEnemigos().get(i).getAnchura()&&this.getX()<=j.getEnemigos().get(i).getY()){
                    j.getEnemigos().get(i).finalizar();
                    this.finalizar();
                    //Incrementar puntos
            ...
            for(Enemigo e:lista){
                ...
                if(this.getY()>=e.getY() && this.getX()>=e.getX() && this.getX()<=e.getAnchura()){
                    e.finalizar();
                    this.finalizar();
                }
            }
